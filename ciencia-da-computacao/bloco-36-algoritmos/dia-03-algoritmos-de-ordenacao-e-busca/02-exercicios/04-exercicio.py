...
# como utiliza dividir e conquistar, consegue ter uma complexidade O(n log n) em média.
...
# pois sua complexidade ainda seria O(n log n) e o bubble sort teria complexidade quadrática O(n²).