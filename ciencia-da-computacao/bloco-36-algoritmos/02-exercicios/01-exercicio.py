...
# escreva um algoritmo que retorna true se há no array um número
# duplicado e false caso contrário. Analise a solução abaixo e diga qual é a ordem de complexidade
