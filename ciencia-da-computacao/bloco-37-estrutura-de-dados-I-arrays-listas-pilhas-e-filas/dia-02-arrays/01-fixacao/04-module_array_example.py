# Este módulo (Módulo array) que já vem na linguagem Python,
# contém uma implementação de arrays compacta e otimizada para
# valores básicos como caracteres, números inteiros e ponto flutuante.
