...
# teste do 2º cenário descrito no arquivo pokemon.py:
...
# que já vem embutido na linguagem e se comporta como o open,
# retornando o que foi definido em read_data como seu conteúdo.
# Um detalhe interessante é que esse objeto obtido através da função
# mock_open também possui a capacidade de armazenar informações sobre
# como foram as chamadas de seus métodos e os parâmetros recebidos.
