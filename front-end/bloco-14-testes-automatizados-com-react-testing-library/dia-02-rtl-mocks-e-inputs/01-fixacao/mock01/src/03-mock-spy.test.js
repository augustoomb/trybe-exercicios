/*
Existem casos nos quais é útil verificar os efeitos colaterais de uma função,
como em uma alteração de um elemento na página, por exemplo. Mas como fazer isso se,
ao mockar uma função, ela perde sua implementação original?
E ao mesmo tempo, sem mockar, não podemos testá-la com o matcher?
...
// CÓDIGO VALIDO. COMENTANDO TEMPORARIAMENTE
...
//   const mockSomar = jest.spyOn(math, "somar"); // não altera a função original, mas simula e 'espia' um mock
...
Como exemplo, imagine que você queira testar a função mockada somar implementando para ela um método de subtração,
mas que depois você queira redefinir as implementações do mock.
