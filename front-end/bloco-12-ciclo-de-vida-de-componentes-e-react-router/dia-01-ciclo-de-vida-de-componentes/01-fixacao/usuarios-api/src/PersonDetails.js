...
class PersonDetails extends Component {
  ...
  // O componentDidMount vai disparar ações após o componente ser inserido no DOM, por isso dizemos que é
  ...
  // a função abaixo foi criada para extrair os dados que precisamos e atribuir
