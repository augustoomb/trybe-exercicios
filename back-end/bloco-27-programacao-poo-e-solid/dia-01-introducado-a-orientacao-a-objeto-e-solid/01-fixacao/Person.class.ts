...
class Person {
  name: string; // se eu não colocar nada, é público
  private _weight: number;
  private _age: number;
  readonly height: number; // recebe valor na instancia, depois não pode ser alterado

  // existe ainda o protected. Ele funciona como o privado. Porem permite que,
  // caso uma classe herde dessa, ela possa usar o atributo. Se fosse privado, não poderia.
