...
export default class BookModel {
  ...
  public async getAll(): Promise<Book[]> {
    ...
    const [rows] = result;
    return rows as Book[]; // convertendo para o tipo Book []
  }
  ...
  public async create(book: Book): Promise<Book> {
    ...
    const result = await this.connection.execute<ResultSetHeader>( // o execute tem um generics que espera eu passar o tipo
