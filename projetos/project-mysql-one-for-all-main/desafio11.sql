SELECT nome_cancao AS nome_musica, CASE
...
WHERE (nome_cancao LIKE '%Streets%') OR 
(nome_cancao LIKE '%Her Own%') OR
(nome_cancao LIKE '%Inner Fire%') OR
(nome_cancao LIKE '%Silly%') OR
