...
# DICA: uso do strip para remover espaços vazios no início da string:
#  https://pt.stackoverflow.com/questions/107841/fun%C3%A7%C3%A3o-equivalente-ao-trim-fun%C3%A7%C3%A3o
# -para-remover-espa%C3%A7os-extras-no-in%C3%ADcio-e-fim
...
def test_brazilian_jobs():
    for index in range(len(english_jobs)):
        assert (
            read_brazilian_file("tests/mocks/brazilians_jobs.csv")[index]
            == english_jobs[index]
        )
