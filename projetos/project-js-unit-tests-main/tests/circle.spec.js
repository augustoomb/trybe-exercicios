...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(circle('augusto')).toBeUndefined();
    ...
    expect(Object.entries(circle(3))[0][1]).toBe(3);
    expect(Object.entries(circle(3))[1][1]).toBeCloseTo(28.26);
    expect(Object.entries(circle(3))[2][1]).toBeCloseTo(18.84);
  });
});


/* Object.entries(circle(3))[0][1]
   Object.entries: busca par chave/valor do obj e colocar cada par em um array. Todos englobados em um grande array
   [0][1]  -  o primeiro [0] item é a linha da iteração, ou seja, cada par/chave valor (cada item do objeto)
           -  o segundo é sempre [1], já quero o valor. Se quisesse a chave seria [0]
*/