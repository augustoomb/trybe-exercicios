...
<details>
  ...
  Foi criada um API utilizando a arquitetura MSC (model-service-controller)!

  A API é um sistema de gerenciamento de vendas no formato dropshipping em que será possível criar, visualizar, deletar e atualizar produtos e vendas. Foi utilizado o banco de dados MySQL para a gestão de dados.
...
<details>
  ...
  <img src="storeManager-result.png" width="800px" >
...
<details>
  <summary><strong>Iniciando</strong></summary>

  1. Clone o repositório

  - `git clone https://github.com/augustoomb/projeto-store-manager';
