...
const createNewArr = (arrBooks) => {
    const buildNewArrBooks = (book) => ({
    ...
    const newArrBooks = arrBooks.map(buildNewArrBooks);
    
    return newArrBooks.sort(sortArr)
}

console.log(createNewArr(books))